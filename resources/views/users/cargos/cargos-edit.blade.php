    ...
    <div class="profile-page">
        ...
        <div class="profile-settings">
            ...
            <main class="profile-content">
                ...
                <form class="add-goods" action="{{ route('cargos.update', [app()->getLocale(), $cargoLoading->id]) }}" method="POST">
                    @csrf
                                ...
                                <div>
                                    <div class="add-goods__inputs__row">
                                        <label for="cargo-name">
                                            <input type="text" name="title" value="{{ $cargoLoading?->cargo?->title ?? '' }}" id="cargo-name" class="add-input input-search" list="cargo-types" required placeholder="Выберите или введите своё">
                                    ...
                                    <div class="add-goods__inputs__row" id="packages_container"
                                         style="display: {{ ($cargoLoading?->cargo?->package_id || $cargoLoading?->cargo?->quantity || $errors->has('package_id') || $errors->has('quantity')) ? 'flex' : 'none' }};">

                                        <label for="package_id"
                                               style="display: {{ (old('package_id', $cargoLoading?->cargo?->package_id) || $errors->has('package_id')) ? 'block' : 'none' }};">
                                            <select name="package_id" id="package_id" class="add-input input-small input-select">
                                                @foreach($packages as $package)
                                                    <option value="{{ $package->id }}" {{ $cargoLoading?->cargo?->package_id == $package->id ? 'selected' : '' }}>
                                                        {{ $package->name }}
                                                    </option>
                                                @endforeach
                                            </select>
                                        ...
                                        <label for="quantity" class="label-value"
                                               style="display: {{ (old('quantity', $cargoLoading?->cargo?->quantity) || $errors->has('quantity')) ? 'block' : 'none' }};">
                                            <input class="add-input input-small input-value"
                                                   name="quantity"
                                                   type="number"
                                                   id="quantity"
                                                   value="{{ $cargoLoading?->cargo?->quantity }}">
                                    ...
                                    <div class="add-goods__inputs__row" id="dimensions_container"
                                         style="display: {{ ($cargoLoading?->cargo?->length || $cargoLoading?->cargo?->width || $cargoLoading?->cargo?->height || $errors->has('length')
                                            || $errors->has('width')
                                            || $errors->has('height')) ? 'flex' : 'none' }};">

                                        <label for="length" class="label-value"
                                               style="display: {{ ($cargoLoading?->cargo?->length || $errors->has('length')) ? 'block' : 'none' }};">
                                            <label>Д</label>
                                            <input class="add-input input-small input-value" name="length" value="{{ $cargoLoading?->cargo?->length }}" type="number" id="length">
                                            @if ($errors->has('length'))<br><p style="color:red;">{{ $errors->first('length') }}</p>@endif
                                            <span>м.</span>
                                        </label>

                                        <label for="width" class="label-value"
                                               style="display: {{ ($cargoLoading?->cargo?->width || $errors->has('width')) ? 'block' : 'none' }};">
                                            <label>Ш</label>
                                            <input class="add-input input-small input-value" name="width" value="{{ $cargoLoading?->cargo?->width }}" type="number" id="width">
                                            @if ($errors->has('width'))<br><p style="color:red;">{{ $errors->first('width') }}</p>@endif
                                            <span>м.</span>
                                        </label>

                                        <label for="height_d" class="label-value"
                                               style="display: {{ ($cargoLoading?->cargo?->height || $errors->has('height')) ? 'block' : 'none' }};">
                                            <label>В</label>
                                            <input class="add-input input-small input-value" name="height" value="{{ $cargoLoading?->cargo?->height }}" type="number" id="height_d">
                                    ...
                                    <div class="add-goods__inputs__row">
                                        ...
                                        <div id="ready_block" style="display: flex; gap: 10px;">
                                            <label for="date" class="add-input input-date">
                                                <span id="date-label-text">{{ $cargoLoading?->cargo?->ready_date?->format('Y-m-d') ?? 'выберите дату'}}</span>
                                                <input type="date" id="date" name="ready_date" value="{{ $cargoLoading?->cargo?->ready_date?->format('Y-m-d') }}">
                                ...
                                <div class="add-goods__inputs no-border">
                                    ...
                                    <div>
                                        ...
                                        <div class="add-goods__inputs__row" id="upload_time_container"
                                             style="display: {{ (old('time_at', $cargoLoading?->time_at ?? '') || old('time_to', $cargoLoading->time_to ?? '') || $errors->has('time_at') || $errors->has('time_to')) ? 'flex' : 'none' }};">

                                            <label for="time_at" class="label-value"
                                                   style="display: {{ (old('time_at', $cargoLoading?->time_at ?? '') || old('time_to') || $errors->has('time_at') || $errors->has('time_to')) ? 'block' : 'none' }};">
                                                <input class="add-input input-small input-value" name="time_at" value="{{ old('time_at', $cargoLoading->time_at?->format('H:i') ?? '') }}" type="time" id="time_at">
                                                @if ($errors->has('time_at'))<br><p style="color:red;">{{ $errors->first('time_at') }}</p>@endif
                                                <input class="add-input input-small input-value" name="time_to" value="{{ old('time_to', $cargoLoading->time_to?->format('H:i') ?? '') }}" type="time" id="time_to">
                                ...
                                <div class="add-goods__inputs">
                                    ...
                                    <div>
                                        ...
                                        <div class="add-goods__inputs__row" id="upload_final_container"
                                             style="display: {{ (old('final_unload_date_from', $cargoLoading?->final_unload_date_from ?? '')
                                                || old('final_unload_date_to', $cargoLoading?->final_unload_date_to ?? '')
                                                || old('final_unload_datetime_from', $cargoLoading?->final_unload_datetime_from ?? '')
                                                || old('final_unload_datetime_to', $cargoLoading?->final_unload_datetime_to ?? '')
                                                || old('final_is_24h', $cargoLoading?->final_is_24h ?? '')
                                            ...
                                            <label for="final_unload_date_from"
                                                   style="display: {{ (old('final_unload_date_from', $cargoLoading?->final_unload_date_from ?? '') || $errors->has('final_unload_date_from')) ? 'block' : 'none' }};">
                                                <input type="date" id="final_unload_date_from" name="final_unload_date_from" value="{{ old('final_unload_date_from', $cargoLoading?->final_unload_date_from?->format('Y-m-d')) }}">
                                            ...
                                            <label for="final_unload_date_to"
                                                   style="display: {{ (old('final_unload_date_to', $cargoLoading?->final_unload_date_to ?? '') || $errors->has('final_unload_date_to')) ? 'block' : 'none' }};">
                                                <input type="date" id="final_unload_date_to" name="final_unload_date_to" value="{{ old('final_unload_date_to', $cargoLoading->final_unload_date_to?->format('Y-m-d')) }}">
                                            ...
                                            <label for="final_unload_datetime_from" class="label-value"
                                                   style="display: {{ (old('final_unload_datetime_from', $cargoLoading?->final_unload_datetime_from ?? '') || old('final_unload_datetime_to', $cargoLoading?->final_unload_datetime_to ?? '') || $errors->has('final_unload_datetime_from') || $errors->has('final_unload_datetime_to')) ? 'block' : 'none' }};">
                                                <input class="add-input input-small input-value" name="final_unload_datetime_from" type="time" value="{{ old('final_unload_datetime_from', $cargoLoading?->final_unload_datetime_from?->format('H:i') ?? '') }}" id="final_unload_datetime_from">
                                                @if ($errors->has('final_unload_datetime_from'))<br><p style="color:red;">{{ $errors->first('final_unload_datetime_from') }}</p>@endif

                                                <input class="add-input input-small input-value" name="final_unload_datetime_to" value="{{ old('final_unload_datetime_to', $cargoLoading?->final_unload_datetime_to?->format('H:i') ?? '') }}" type="time" id="final_unload_datetime_to">
                                        ...
                                        <div class="add-inputs-card_block border">
                                            <label for="all" class="add-input-general">
                                                <input type="checkbox" name="body_types[]" id="all" value="все закр.+изотерм"
                                                        {{ in_array('все закр.+изотерм', old('body_types', $cargoLoading->body_types ?? [])) ? 'checked' : '' }}>
                                                все закр.+изотерм
                                            </label>
                                            <label for="tnt">
                                                <span></span>
                                                <input type="checkbox" name="body_types[]" id="tnt" value="тентованный"
                                                        {{ in_array('тентованный', old('body_types', $cargoLoading->body_types ?? [])) ? 'checked' : '' }}>
                                                тентованный
                                            </label>
                                            <label for="cn">
                                                <span></span>
                                                <input type="checkbox" name="body_types[]" id="cn" value="контейнер"
                                                        {{ in_array('контейнер', old('body_types', $cargoLoading->body_types ?? [])) ? 'checked' : '' }}>
                                                контейнер
                                            </label>
                                            <label for="fr">
                                                <span></span>
                                                <input type="checkbox" name="body_types[]" id="fr" value="фургон"
                                                        {{ in_array('фургон', old('body_types', $cargoLoading->body_types ?? [])) ? 'checked' : '' }}>
                                                фургон
                                            </label>
                                            <label for="mt">
                                                <span></span>
                                                <input type="checkbox" name="body_types[]" id="mt" value="цельнометалл"
                                                        {{ in_array('цельнометалл', old('body_types', $cargoLoading->body_types ?? [])) ? 'checked' : '' }}>
                                                цельнометалл.
                                            </label>
                                        </div>
                                        ...
                                        <div class="add-inputs-card_block">
                                            <label for="изотермический">
                                                <input type="checkbox" name="body_types[]" id="изотермический" value="изотермический"
                                                        {{ in_array('изотермический', old('body_types', $cargoLoading->body_types ?? [])) ? 'checked' : '' }}>
                                                изотермический
                                            </label>
                                        </div>
                                        ...
                                        <div class="add-inputs-card_block border">
                                            <label for="refz" class="add-input-general">
                                                <input type="checkbox" name="body_types[]" id="refz" value="реф.+изотерм"
                                                        {{ in_array('реф.+изотерм', old('body_types', $cargoLoading->body_types ?? [])) ? 'checked' : '' }}>
                                                реф.+изотерм
                                            </label>
                                            <label for="refrijetor">
                                                <span></span>
                                                <input type="checkbox" name="body_types[]" id="refrijetor" value="рефрижератор"
                                                        {{ in_array('рефрижератор', old('body_types', $cargoLoading->body_types ?? [])) ? 'checked' : '' }}>
                                                рефрижератор
                                            </label>
                                            <label for="ref-s-peregorodkoy">
                                                <span></span>
                                                <input type="checkbox" name="body_types[]" id="ref-s-peregorodkoy" value="реф. с перегородкой"
                                                        {{ in_array('реф. с перегородкой', old('body_types', $cargoLoading->body_types ?? [])) ? 'checked' : '' }}>
                                                реф. с перегородкой
                                            </label>
                                            <label for="ref-multi">
                                                <span></span>
                                                <input type="checkbox" name="body_types[]" id="ref-multi" value="реф. мультирежимный"
                                                        {{ in_array('реф. мультирежимный', old('body_types', $cargoLoading->body_types ?? [])) ? 'checked' : '' }}>
                                                реф. мультирежимный
                                            </label>
                                        </div>
                                        ...
                                        <div class="add-inputs-card_block">
                                            <label for="реф.-тушевоз">
                                                <input type="checkbox" name="body_types[]" id="реф.-тушевоз" value="реф.-тушевоз"
                                                        {{ in_array('реф.-тушевоз', old('body_types', $cargoLoading->body_types ?? [])) ? 'checked' : '' }}>
                                                реф.-тушевоз
                                            </label>
                                        </div>
                                        ...
                                        <div class="add-inputs-card_block border">
                                            <label for="open_all" class="add-input-general">
                                                <input type="checkbox" name="body_types[]" id="open_all" value="все открытые"
                                                        {{ in_array('все открытые', old('body_types', $cargoLoading->body_types ?? [])) ? 'checked' : '' }}>
                                                все открытые
                                            </label>
                                            <label for="bord">
                                                <input type="checkbox" name="body_types[]" id="bord" value="бортовой"
                                                        {{ in_array('бортовой', old('body_types', $cargoLoading->body_types ?? [])) ? 'checked' : '' }}>
                                                бортовой
                                            </label>
                                            <label for="open_cont">
                                                <input type="checkbox" name="body_types[]" id="open_cont" value="открытый конт."
                                                        {{ in_array('открытый конт.', old('body_types', $cargoLoading->body_types ?? [])) ? 'checked' : '' }}>
                                                открытый конт.
                                            </label>
                                            <label for="sam">
                                                <input type="checkbox" name="body_types[]" id="sam" value="самосвал"
                                                        {{ in_array('самосвал', old('body_types', $cargoLoading->body_types ?? [])) ? 'checked' : '' }}>
                                                самосвал
                                            </label>
                                            <label for="shal">
                                                <input type="checkbox" name="body_types[]" id="shal" value="шаланда"
                                                        {{ in_array('шаланда', old('body_types', $cargoLoading->body_types ?? [])) ? 'checked' : '' }}>
                                                шаланда
                                            </label>
                                            <label for="plat">
                                                <input type="checkbox" name="body_types[]" id="plat" value="площадка без бортов"
                                                        {{ in_array('площадка без бортов', old('body_types', $cargoLoading->body_types ?? [])) ? 'checked' : '' }}>
                                                площадка без бортов
                                            </label>
                                        </div>
                                        ...
                                        <div class="add-inputs-card_block">
                                            <label for="bus">
                                                <input type="checkbox" name="body_types[]" id="bus" value="автобус"
                                                        {{ in_array('автобус', old('body_types', $cargoLoading->body_types ?? [])) ? 'checked' : '' }}>
                                                автобус
                                            </label>
                                            <label for="avto">
                                                <input type="checkbox" name="body_types[]" id="avto" value="автовоз"
                                                        {{ in_array('автовоз', old('body_types', $cargoLoading->body_types ?? [])) ? 'checked' : '' }}>
                                                автовоз
                                            </label>
                                            <label for="avto_vishka">
                                                <input type="checkbox" name="body_types[]" id="avto_vishka" value="автовышка"
                                                        {{ in_array('автовышка', old('body_types', $cargoLoading->body_types ?? [])) ? 'checked' : '' }}>
                                                автовышка
                                            </label>
                                            <label for="avtotrans">
                                                <input type="checkbox" name="body_types[]" id="avtotrans" value="автотранспортер"
                                                        {{ in_array('автотранспортер', old('body_types', $cargoLoading->body_types ?? [])) ? 'checked' : '' }}>
                                                автотранспортер
                                            </label>
                                            <label for="beton">
                                                <input type="checkbox" name="body_types[]" id="beton" value="бетоновоз"
                                                        {{ in_array('бетоновоз', old('body_types', $cargoLoading->body_types ?? [])) ? 'checked' : '' }}>
                                                бетоновоз
                                            </label>
                                            <label for="bitum">
                                                <input type="checkbox" name="body_types[]" id="bitum" value="битумовоз"
                                                        {{ in_array('битумовоз', old('body_types', $cargoLoading->body_types ?? [])) ? 'checked' : '' }}>
                                                битумовоз
                                            </label>
                                            <label for="benz">
                                                <input type="checkbox" name="body_types[]" id="benz" value="бензовоз"
                                                        {{ in_array('бензовоз', old('body_types', $cargoLoading->body_types ?? [])) ? 'checked' : '' }}>
                                                бензовоз
                                            </label>
                                            <label for="vezdehod">
                                                <input type="checkbox" name="body_types[]" id="vezdehod" value="вездеход"
                                                        {{ in_array('вездеход', old('body_types', $cargoLoading->body_types ?? [])) ? 'checked' : '' }}>
                                                вездеход
                                            </label>
                                            <label for="gaz">
                                                <input type="checkbox" name="body_types[]" id="gaz" value="газовоз"
                                                        {{ in_array('газовоз', old('body_types', $cargoLoading->body_types ?? [])) ? 'checked' : '' }}>
                                                газовоз
                                            </label>
                                            <label for="zerno">
                                                <input type="checkbox" name="body_types[]" id="zerno" value="зерновоз"
                                                        {{ in_array('зерновоз', old('body_types', $cargoLoading->body_types ?? [])) ? 'checked' : '' }}>
                                                зерновоз
                                            </label>
                                            <label for="konevoz">
                                                <input type="checkbox" name="body_types[]" id="konevoz" value="коневоз"
                                                        {{ in_array('коневоз', old('body_types', $cargoLoading->body_types ?? [])) ? 'checked' : '' }}>
                                                коневоз
                                            </label>
                                            <label for="konteynerovoz">
                                                <input type="checkbox" name="body_types[]" id="konteynerovoz" value="контейнеровоз"
                                                        {{ in_array('контейнеровоз', old('body_types', $cargoLoading->body_types ?? [])) ? 'checked' : '' }}>
                                                контейнеровоз
                                            </label>
                                            <label for="kormovoz">
                                                <input type="checkbox" name="body_types[]" id="kormovoz" value="кормовоз"
                                                        {{ in_array('кормовоз', old('body_types', $cargoLoading->body_types ?? [])) ? 'checked' : '' }}>
                                                кормовоз
                                            </label>
                                            <label for="kran">
                                                <input type="checkbox" name="body_types[]" id="kran" value="кран"
                                                        {{ in_array('кран', old('body_types', $cargoLoading->body_types ?? [])) ? 'checked' : '' }}>
                                                кран
                                            </label>
                                            <label for="lesovoz">
                                                <input type="checkbox" name="body_types[]" id="lesovoz" value="лесовоз"
                                                        {{ in_array('лесовоз', old('body_types', $cargoLoading->body_types ?? [])) ? 'checked' : '' }}>
                                                лесовоз
                                            </label>
                                            <label for="lomovoz">
                                                <input type="checkbox" name="body_types[]" id="lomovoz" value="ломовоз"
                                                        {{ in_array('ломовоз', old('body_types', $cargoLoading->body_types ?? [])) ? 'checked' : '' }}>
                                                ломовоз
                                            </label>
                                            <label for="manip">
                                                <input type="checkbox" name="body_types[]" id="manip" value="манипулятор"
                                                        {{ in_array('манипулятор', old('body_types', $cargoLoading->body_types ?? [])) ? 'checked' : '' }}>
                                                манипулятор
                                            </label>
                                            <label for="micro">
                                                <input type="checkbox" name="body_types[]" id="micro" value="микроавтобус"
                                                        {{ in_array('микроавтобус', old('body_types', $cargoLoading->body_types ?? [])) ? 'checked' : '' }}>
                                                микроавтобус
                                            </label>
                                            <label for="mukovoz">
                                                <input type="checkbox" name="body_types[]" id="mukovoz" value="муковоз"
                                                        {{ in_array('муковоз', old('body_types', $cargoLoading->body_types ?? [])) ? 'checked' : '' }}>
                                                муковоз
                                            </label>
                                            <label for="panel">
                                                <input type="checkbox" name="body_types[]" id="panel" value="панелевоз"
                                                        {{ in_array('панелевоз', old('body_types', $cargoLoading->body_types ?? [])) ? 'checked' : '' }}>
                                                панелевоз
                                            </label>
                                            <label for="pickup">
                                                <input type="checkbox" name="body_types[]" id="pickup" value="пикап"
                                                        {{ in_array('пикап', old('body_types', $cargoLoading->body_types ?? [])) ? 'checked' : '' }}>
                                                пикап
                                            </label>
                                            <label for="puhtovoz">
                                                <input type="checkbox" name="body_types[]" id="puhtovoz" value="пухтовоз"
                                                        {{ in_array('пухтовоз', old('body_types', $cargoLoading->body_types ?? [])) ? 'checked' : '' }}>
                                                пухтовоз
                                            </label>
                                            <label for="pir">
                                                <input type="checkbox" name="body_types[]" id="pir" value="пирамида"
                                                        {{ in_array('пирамида', old('body_types', $cargoLoading->body_types ?? [])) ? 'checked' : '' }}>
                                                пирамида
                                            </label>
                                            <label for="rulon">
                                                <input type="checkbox" name="body_types[]" id="rulon" value="рулоновоз"
                                                        {{ in_array('рулоновоз', old('body_types', $cargoLoading->body_types ?? [])) ? 'checked' : '' }}>
                                                рулоновоз
                                            </label>
                                            <label for="tyagach">
                                                <input type="checkbox" name="body_types[]" id="tyagach" value="седельный тягач"
                                                        {{ in_array('седельный тягач', old('body_types', $cargoLoading->body_types ?? [])) ? 'checked' : '' }}>
                                                седельный тягач
                                            </label>
                                            <label for="skotovoz">
                                                <input type="checkbox" name="body_types[]" id="skotovoz" value="скотовоз"
                                                        {{ in_array('скотовоз', old('body_types', $cargoLoading->body_types ?? [])) ? 'checked' : '' }}>
                                                скотовоз
                                            </label>
                                            <label for="steklovoz">
                                                <input type="checkbox" name="body_types[]" id="steklovoz" value="стекловоз"
                                                        {{ in_array('стекловоз', old('body_types', $cargoLoading->body_types ?? [])) ? 'checked' : '' }}>
                                                стекловоз
                                            </label>
                                            <label for="trubovoz">
                                                <input type="checkbox" name="body_types[]" id="trubovoz" value="трубовоз"
                                                        {{ in_array('трубовоз', old('body_types', $cargoLoading->body_types ?? [])) ? 'checked' : '' }}>
                                                трубовоз
                                            </label>
                                            <label for="cement">
                                                <input type="checkbox" name="body_types[]" id="cement" value="цементовоз"
                                                        {{ in_array('цементовоз', old('body_types', $cargoLoading->body_types ?? [])) ? 'checked' : '' }}>
                                                цементовоз
                                            </label>
                                            <label for="cistern">
                                                <input type="checkbox" name="body_types[]" id="cistern" value="автоцистерна"
                                                        {{ in_array('автоцистерна', old('body_types', $cargoLoading->body_types ?? [])) ? 'checked' : '' }}>
                                                автоцистерна
                                            </label>
                                            <label for="schepa">
                                                <input type="checkbox" name="body_types[]" id="schepa" value="щеповоз"
                                                        {{ in_array('щеповоз', old('body_types', $cargoLoading->body_types ?? [])) ? 'checked' : '' }}>
                                                щеповоз
                                            </label>
                                            <label for="evakuator">
                                                <input type="checkbox" name="body_types[]" id="evakuator" value="эвакуатор"
                                                        {{ in_array('эвакуатор', old('body_types', $cargoLoading->body_types ?? [])) ? 'checked' : '' }}>
                                                эвакуатор
                                            </label>
                                            <label for="gruzpas">
                                                <input type="checkbox" name="body_types[]" id="gruzpas" value="грузопассажирский"
                                                        {{ in_array('грузопассажирский', old('body_types', $cargoLoading->body_types ?? [])) ? 'checked' : '' }}>
                                                грузопассажирский
                                            </label>
                                            <label for="klyushka">
                                                <input type="checkbox" name="body_types[]" id="klyushka" value="клюшковоз"
                                                        {{ in_array('клюшковоз', old('body_types', $cargoLoading->body_types ?? [])) ? 'checked' : '' }}>
                                                клюшковоз
                                            </label>
                                            <label for="musor">
                                                <input type="checkbox" name="body_types[]" id="musor" value="мусоровоз"
                                                        {{ in_array('мусоровоз', old('body_types', $cargoLoading->body_types ?? [])) ? 'checked' : '' }}>
                                                мусоровоз
                                            </label>
                                            <label for="jumbo">
                                                <input type="checkbox" name="body_types[]" id="jumbo" value="jumbo"
                                                        {{ in_array('jumbo', old('body_types', $cargoLoading->body_types ?? [])) ? 'checked' : '' }}>
                                                jumbo
                                            </label>
                                            <label for="tank20">
                                                <input type="checkbox" name="body_types[]" id="tank20" value="20' танк-контейнер"
                                                        {{ in_array("20' танк-контейнер", old('body_types', $cargoLoading->body_types ?? [])) ? 'checked' : '' }}>
                                                20' танк-контейнер
                                            </label>
                                            <label for="tank40">
                                                <input type="checkbox" name="body_types[]" id="tank40" value="40' танк-контейнер"
                                                        {{ in_array("40' танк-контейнер", old('body_types', $cargoLoading->body_types ?? [])) ? 'checked' : '' }}>
                                                40' танк-контейнер
                                            </label>
                                            <label for="mega">
                                                <input type="checkbox" name="body_types[]" id="mega" value="мега фура"
                                                        {{ in_array('мега фура', old('body_types', $cargoLoading->body_types ?? [])) ? 'checked' : '' }}>
                                                мега фура
                                            </label>
                                            <label for="doppelstock">
                                                <input type="checkbox" name="body_types[]" id="doppelstock" value="допельшток"
                                                        {{ in_array('допельшток', old('body_types', $cargoLoading->body_types ?? [])) ? 'checked' : '' }}>
                                                допельшток
                                            </label>
                                            <label for="razdvizh">
                                                <input type="checkbox" name="body_types[]" id="razdvizh" value="Раздвижной полуприцеп 20'/40'"
                                                        {{ in_array("Раздвижной полуприцеп 20'/40'", old('body_types', $cargoLoading->body_types ?? [])) ? 'checked' : '' }}>
                                        ...
                                        <div class="add-inputs-card_block">
                                            <label for="1">
                                                <input type="checkbox" name="loading_types[]" id="1" value="верхняя"
                                                        {{ in_array('верхняя', old('loading_types', $cargoLoading->loading_types ?? [])) ? 'checked' : '' }}>
                                                верхняя
                                            </label>
                                            <label for="2">
                                                <input type="checkbox" name="loading_types[]" id="2" value="боковая"
                                                        {{ in_array('боковая', old('loading_types', $cargoLoading->loading_types ?? [])) ? 'checked' : '' }}>
                                                боковая
                                            </label>
                                            <label for="3">
                                                <input type="checkbox" name="loading_types[]" id="3" value="задняя"
                                                        {{ in_array('задняя', old('loading_types', $cargoLoading->loading_types ?? [])) ? 'checked' : '' }}>
                                                задняя
                                            </label>
                                            <label for="4">
                                                <input type="checkbox" name="loading_types[]" id="4" value="с полной растентовкой"
                                                        {{ in_array('с полной растентовкой', old('loading_types', $cargoLoading->loading_types ?? [])) ? 'checked' : '' }}>
                                                с полной растентовкой
                                            </label>
                                            <label for="5">
                                                <input type="checkbox" name="loading_types[]" id="5" value="со снятием поперечных перекладин"
                                                        {{ in_array('со снятием поперечных перекладин', old('loading_types', $cargoLoading->loading_types ?? [])) ? 'checked' : '' }}>
                                            ...
                                            <label for="55">
                                                <input type="checkbox" name="loading_types[]" id="55" value="со снятием стоек"
                                                        {{ in_array('со снятием стоек', old('loading_types', $cargoLoading->loading_types ?? [])) ? 'checked' : '' }}>
                                                со снятием стоек
                                            </label>

                                            <label for="66">
                                                <input type="checkbox" name="loading_types[]" id="66" value="без ворот"
                                                        {{ in_array('без ворот', old('loading_types', $cargoLoading->loading_types ?? [])) ? 'checked' : '' }}>
                                                без ворот
                                            </label>
                                            <label for="77">
                                                <input type="checkbox" name="loading_types[]" id="77" value="гидроборт"
                                                        {{ in_array('гидроборт', old('loading_types', $cargoLoading->loading_types ?? [])) ? 'checked' : '' }}>
                                                гидроборт
                                            </label>
                                            <label for="88">
                                                <input type="checkbox" name="loading_types[]" id="88" value="аппарели"
                                                        {{ in_array('аппарели', old('loading_types', $cargoLoading->loading_types ?? [])) ? 'checked' : '' }}>
                                                аппарели
                                            </label>
                                            <label for="99">
                                                <input type="checkbox" name="loading_types[]" id="99" value="с обрешеткой"
                                                        {{ in_array('с обрешеткой', old('loading_types', $cargoLoading->loading_types ?? [])) ? 'checked' : '' }}>
                                                с обрешеткой
                                            </label>
                                            <label for="1010">
                                                <input type="checkbox" name="loading_types[]" id="1010" value="с бортами"
                                                        {{ in_array('с бортами', old('loading_types', $cargoLoading->loading_types ?? [])) ? 'checked' : '' }}>
                                                с бортами
                                            </label>
                                            <label for="1011">
                                                <input type="checkbox" name="loading_types[]" id="1011" value="боковая с 2-х сторон"
                                                        {{ in_array('боковая с 2-х сторон', old('loading_types', $cargoLoading->loading_types ?? [])) ? 'checked' : '' }}>
                                                боковая с 2-х сторон
                                            </label>
                                            <label for="1012">
                                                <input type="checkbox" name="loading_types[]" id="1012" value="налив"
                                                        {{ in_array('налив', old('loading_types', $cargoLoading->loading_types ?? [])) ? 'checked' : '' }}>
                                                налив
                                            </label>
                                            <label for="1013">
                                                <input type="checkbox" name="loading_types[]" id="1013" value="электрический"
                                                        {{ in_array('электрический', old('loading_types', $cargoLoading->loading_types ?? [])) ? 'checked' : '' }}>
                                                электрический
                                            </label>
                                            <label for="1014">
                                                <input type="checkbox" name="loading_types[]" id="1014" value="гидравлический"
                                                        {{ in_array('гидравлический', old('loading_types', $cargoLoading->loading_types ?? [])) ? 'checked' : '' }}>
                                                гидравлический
                                            </label>
                                            <label for="1015">
                                                <input type="checkbox" name="loading_types[]" id="1015" value="пневматический"
                                                        {{ in_array('пневматический', old('loading_types', $cargoLoading->loading_types ?? [])) ? 'checked' : '' }}>
                                                пневматический
                                            </label>
                                            <label for="1016">
                                                <input type="checkbox" name="loading_types[]" id="1016" value="дизельный компрессор"
                                                        {{ in_array('дизельный компрессор', old('loading_types', $cargoLoading->loading_types ?? [])) ? 'checked' : '' }}>
                                        ...
                                        <div class="add-inputs-card_block">
                                            <label for="111">
                                                <input type="checkbox" name="unloading_types[]" id="111" value="верхняя"
                                                        {{ in_array('верхняя', old('unloading_types', $cargoLoading->unloading_types ?? [])) ? 'checked' : '' }}>
                                                верхняя
                                            </label>
                                            <label for="222">
                                                <input type="checkbox" name="unloading_types[]" id="222" value="боковая"
                                                        {{ in_array('боковая', old('unloading_types', $cargoLoading->unloading_types ?? [])) ? 'checked' : '' }}>
                                                боковая
                                            </label>
                                            <label for="333">
                                                <input type="checkbox" name="unloading_types[]" id="333" value="задняя"
                                                        {{ in_array('задняя', old('unloading_types', $cargoLoading->unloading_types ?? [])) ? 'checked' : '' }}>
                                                задняя
                                            </label>
                                            <label for="444">
                                                <input type="checkbox" name="unloading_types[]" id="444" value="с полной растентовкой"
                                                        {{ in_array('с полной растентовкой', old('unloading_types', $cargoLoading->unloading_types ?? [])) ? 'checked' : '' }}>
                                                с полной растентовкой
                                            </label>
                                            <label for="555">
                                                <input type="checkbox" name="unloading_types[]" id="555" value="со снятием поперечных перекладин"
                                                        {{ in_array('со снятием поперечных перекладин', old('unloading_types', $cargoLoading->unloading_types ?? [])) ? 'checked' : '' }}>
                                                со снятием поперечных перекладин
                                            </label>
                                            ...
                                            <label for="666">
                                                <input type="checkbox" name="unloading_types[]" id="666" value="со снятием стоек"
                                                        {{ in_array('со снятием стоек', old('unloading_types', $cargoLoading->unloading_types ?? [])) ? 'checked' : '' }}>
                                                со снятием стоек
                                            </label>

                                            <label for="777">
                                                <input type="checkbox" name="unloading_types[]" id="777" value="без ворот"
                                                        {{ in_array('без ворот', old('unloading_types', $cargoLoading->unloading_types ?? [])) ? 'checked' : '' }}>
                                                без ворот
                                            </label>
                                            <label for="888">
                                                <input type="checkbox" name="unloading_types[]" id="888" value="гидроборт"
                                                        {{ in_array('гидроборт', old('unloading_types', $cargoLoading->unloading_types ?? [])) ? 'checked' : '' }}>
                                                гидроборт
                                            </label>
                                            <label for="999">
                                                <input type="checkbox" name="unloading_types[]" id="999" value="аппарели"
                                                        {{ in_array('аппарели', old('unloading_types', $cargoLoading->unloading_types ?? [])) ? 'checked' : '' }}>
                                                аппарели
                                            </label>
                                            <label for="101010">
                                                <input type="checkbox" name="unloading_types[]" id="101010" value="с обрешеткой"
                                                        {{ in_array('с обрешеткой', old('unloading_types', $cargoLoading->unloading_types ?? [])) ? 'checked' : '' }}>
                                                с обрешеткой
                                            </label>
                                            <label for="111111">
                                                <input type="checkbox" name="unloading_types[]" id="111111" value="с бортами"
                                                        {{ in_array('с бортами', old('unloading_types', $cargoLoading->unloading_types ?? [])) ? 'checked' : '' }}>
                                                с бортами
                                            </label>
                                            <label for="121212">
                                                <input type="checkbox" name="unloading_types[]" id="121212" value="боковая с 2-х сторон"
                                                        {{ in_array('боковая с 2-х сторон', old('unloading_types', $cargoLoading->unloading_types ?? [])) ? 'checked' : '' }}>
                                                боковая с 2-х сторон
                                            </label>
                                            <label for="131313">
                                                <input type="checkbox" name="unloading_types[]" id="131313" value="налив"
                                                        {{ in_array('налив', old('unloading_types', $cargoLoading->unloading_types ?? [])) ? 'checked' : '' }}>
                                                налив
                                            </label>
                                            <label for="141414">
                                                <input type="checkbox" name="unloading_types[]" id="141414" value="электрический"
                                                        {{ in_array('электрический', old('unloading_types', $cargoLoading->unloading_types ?? [])) ? 'checked' : '' }}>
                                                электрический
                                            </label>
                                            <label for="151515">
                                                <input type="checkbox" name="unloading_types[]" id="151515" value="гидравлический"
                                                        {{ in_array('гидравлический', old('unloading_types', $cargoLoading->unloading_types ?? [])) ? 'checked' : '' }}>
                                                гидравлический
                                            </label>
                                            <label for="161616">
                                                <input type="checkbox" name="unloading_types[]" id="161616" value="пневматический"
                                                        {{ in_array('пневматический', old('unloading_types', $cargoLoading->unloading_types ?? [])) ? 'checked' : '' }}>
                                                пневматический
                                            </label>
                                            <label for="171717">
                                                <input type="checkbox" name="unloading_types[]" id="171717" value="дизельный компрессор"
                                                        {{ in_array('дизельный компрессор', old('unloading_types', $cargoLoading->unloading_types ?? [])) ? 'checked' : '' }}>
                                                дизельный компрессор
                                            </label>
                                        </div>
                                    </div>
                                ...
                                <div class="add-goods__bid-row">
                                    ...
                                    <label>
                                        <select name="currency" id="currency" class="input-select">
                                            <option value="узб.сум" {{ old('currency', $cargoLoading->currency) === 'узб.сум' ? 'selected' : '' }}>узб.сум</option>
                                            <option value="узб.сум/км" {{ old('currency', $cargoLoading->currency) === 'узб.сум/км' ? 'selected' : '' }}>узб.сум/км</option>
                                            <option value="узб.сум/т" {{ old('currency', $cargoLoading->currency) === 'узб.сум/т' ? 'selected' : '' }}>узб.сум/т</option>
                                            <option value="доллар" {{ old('currency', $cargoLoading->currency) === 'доллар' ? 'selected' : '' }}>доллар</option>
                                            <option value="доллар/км" {{ old('currency', $cargoLoading->currency) === 'доллар/км' ? 'selected' : '' }}>доллар/км</option>
                                            <option value="доллар/т" {{ old('currency', $cargoLoading->currency) === 'доллар/т' ? 'selected' : '' }}>доллар/т</option>
                                            <option value="евро" {{ old('currency', $cargoLoading->currency) === 'евро' ? 'selected' : '' }}>евро</option>
                                            <option value="евро/км" {{ old('currency', $cargoLoading->currency) === 'евро/км' ? 'selected' : '' }}>евро/км</option>
                                            <option value="евро/т" {{ old('currency', $cargoLoading->currency) === 'евро/т' ? 'selected' : '' }}>евро/т</option>
                                            <option value="руб" {{ old('currency', $cargoLoading->currency) === 'руб' ? 'selected' : '' }}>руб</option>
                                            <option value="руб/км" {{ old('currency', $cargoLoading->currency) === 'руб/км' ? 'selected' : '' }}>руб/км</option>
                                            <option value="руб/т" {{ old('currency', $cargoLoading->currency) === 'руб/т' ? 'selected' : '' }}>руб/т</option>
                                        </select>
                                    </label>
                                </div>
                                <div class="add-goods__bid-row">
