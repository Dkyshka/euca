                                ...
                                <div>
                                    ...
                                    <div class="add-goods__inputs__row" id="packages_container"
                                        ...
                                        <label for="quantity" class="label-value"
                                               style="display: {{ ($cargoLoading?->cargo?->quantity || $errors->has('quantity')) ? 'block' : 'none' }};">
                                    ...
                                    <div class="add-goods__inputs__row">
                                        ...
                                        <div id="ready_block" style="display: flex; gap: 10px;">
                                            <label for="date" class="add-input input-date">
                                                <span id="date-label-text">{{ $cargoLoading?->cargo?->ready_date ?? 'выберите дату'}}</span>
                                                <input type="date" id="date" name="ready_date" value="{{ $cargoLoading?->cargo?->ready_date }}">
